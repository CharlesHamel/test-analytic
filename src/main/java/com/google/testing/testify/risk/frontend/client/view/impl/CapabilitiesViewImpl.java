...
public class CapabilitiesViewImpl extends Composite implements CapabilitiesView {
  ...
  private static final String HEADER_TEXT = "Capacités par attribut et composant";
  ...
  public CapabilitiesViewImpl() {
    ...
    newCapabilityName.getElement().setAttribute("placeholder", "Ajouter une nouvelle capacité...");
  }
  ...
  protected void handleNewButton(ClickEvent e) {
    ...
    if (name.length() == 0) {
      Window.alert("Veuillez saisir un nom pour la capacité.");
      return;
    }
  ...
  private void tryToPopulateCapabilitiesPanel() {
    if (selectedIntersection != null && attributes != null && components != null
      ...
      capabilitiesContainerTitle.setText(component.getName() + " est " + attribute.getName());

...
public class TaApplication extends Composite {
  ...
  private void initializeToolbar() {
    ...
    projectService.queryUserProjects(
        new TaCallback<List<Project>>("Recherche de projets") {
          @Override
    ...
    userService.getStarredProjects(
        new TaCallback<List<Long>>("récupération de projets favoris") {
          @Override
  ...
  public void switchToPage(String historyToken, String pageData) {
    ...
    NotificationUtil.displayErrorMessage("La page demandée est actuellement indisponible.");
  }
  ...
  private TaPagePresenter createBugsPage() {
    ...
    dataView.setPageText(
      "Bugs du Projet",
      "Les bugs suivants ont été téléchargés dans votre projet Test Analytics.");
        ...
        new Function<Void, Void>() {
          ...
          public Void apply(Void input) {
            dataService.getProjectBugsById(getProject().getProjectId(),
                new TaCallback<List<Bug>>("Recherche des bugs du projet") {
                  @Override
  ...
  private TaPagePresenter createCheckinsPage() {
    ...
    dataView.setPageText(
      "Archivage de projet",
      "Les enregistrements suivants ont été téléchargés dans votre projet Test Analytics.");
        ...
        new Function<Void, Void>() {
          ...
          public Void apply(Void input) {
            dataService.getProjectCheckinsById(getProject().getProjectId(),
                new TaCallback<List<Checkin>>("Recherche des enregistrements de projet") {
                  @Override
  ...
  private TaPagePresenter createTestcasesPage() {
    ...
    final ProjectDataViewImpl dataView = new ProjectDataViewImpl();
    dataView.setPageText(
        "Cas de test de projet",
        "Les cas de test suivants ont été téléchargés dans votre projet Test Analytics.");
        ...
        new Function<Void, Void>() {
          ...
          public Void apply(Void input) {
            dataService.getProjectTestCasesById(getProject().getProjectId(),
                new TaCallback<List<TestCase>>("Recherche des cas de test de projet") {
                  @Override

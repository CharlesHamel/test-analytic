...
public class TaEntryPoint implements EntryPoint {
  ...
  private static final String INVALID_URL_TEXT = "La page est introuvable.";
  private static final String INVALID_PROJECT_ID_TEXT = "Aucun projet avec cet ID n'a été trouvé.";

  // Project-load related error messages.
  private static final String ERROR_LOADING_PROJECT = "Erreur lors du chargement du projet";
  private static final String ERROR_LOADING_PROJECT_TEXT =
      "Une erreur s'est produite lors du chargement du projet demandé";
  private static final String PROJECT_NOT_FOUND = "Projet introuvable";
  private static final String PROJECT_ID_NOT_FOUND_TEXT = "Aucun projet avec cet ID n'a été trouvé.";
  ...
  private void displayErrorPage(String errorType, String errorMessage) {
    GWT.log("Erreur générale: " + errorType);
  ...
  public void displayProjectView(Project project) {
    ...
    GWT.log("Basculer pour afficher le projet " + project.getProjectId().toString());

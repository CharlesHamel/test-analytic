...
public class KnownRiskViewImpl extends RiskViewImpl {
  ...
  public KnownRiskViewImpl() {
    String introText =
      "Cela montre le risque total pour votre application, en tenant compte des sources de risque "
      + "ainsi que les sources d'atténuation qui sont vérifiées ci-dessous.";
    setPageText("Risque connu", introText);
  ...
  private Widget createBottomWidget(CapabilityIntersectionData data) {
    ...
    Label name = new Label(cName + " est " + aName);
